...
internal enum StoryboardScene {
  internal enum Authentication: StoryboardType {
    ...
    internal static let authenticationOptionsSelector = SceneType<XsollaLoginDemo.AuthenticationOptionsSelectorVC>(storyboard: Authentication.self, identifier: "AuthenticationOptionsSelector")
  ...
  internal enum AuthenticationOTP: StoryboardType {
    ...
    internal static let otpInputCode = SceneType<XsollaLoginDemo.OTPInputCodeVC>(storyboard: AuthenticationOTP.self, identifier: "OTPInputCode")

    internal static let otpStart = SceneType<XsollaLoginDemo.OTPStartVC>(storyboard: AuthenticationOTP.self, identifier: "OTPStart")
  }
  ...
  internal enum SocialNetworksList: StoryboardType {
    ...
    internal static let socialNetworksList = SceneType<XsollaLoginDemo.SocialNetworksListVC>(storyboard: SocialNetworksList.self, identifier: "SocialNetworksList")
  }
  internal enum UserProfile: StoryboardType {
    internal static let storyboardName = "UserProfile"

    internal static let connectedDevicesList = SceneType<XsollaLoginDemo.ConnectedDevicesListVC>(storyboard: UserProfile.self, identifier: "ConnectedDevicesList")

    internal static let upgradeAccount = SceneType<XsollaLoginDemo.UpgradeAccountVC>(storyboard: UserProfile.self, identifier: "UpgradeAccount")
